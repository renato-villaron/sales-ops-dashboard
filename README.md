...
1. **Pulls live data** from SQL databases and an internal Google Sheets
2. **Displays KPIs** per supervisor, per hour, with conversion rates and call volume
3. **Projects end-of-day closing numbers** based on historical and current pace
4. **Triggers automatic rerouting** of agents across campaigns when metrics fall below defined thresholds
